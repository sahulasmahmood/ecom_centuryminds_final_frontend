        ...
        <div className="relative hidden lg:block bg-black overflow-hidden bg-[radial-gradient(169.40%_89.55%_at_94.76%_6.29%,rgba(0,0,0,0.40)_0%,rgba(255,255,255,0.00)_100%)]">
          ...
          <div className="relative z-10 flex flex-col justify-end h-full p-12">
            ...
            <h2 className="text-4xl font-bold text-white mb-4 tracking-tight drop-shadow-lg">
              Join the <span className="text-secondary italic">Sparkle</span>
            </h2>
            <p className="text-white/80 text-lg max-w-md drop-shadow-md">
              Create your account and start your celebration journey today.
            </p>
          </div>
        </div>
                ...
                <div className="text-center space-y-4 py-8">
                  <div className="flex justify-center">
                    <div className="w-16 h-16 bg-green-500/20 rounded-full flex items-center justify-center">
                      <IconMail size={32} className="text-green-500" />
                    </div>
                  </div>
                  <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="w-full h-11 pl-10 pr-4 bg-muted border border-border rounded text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary transition-colors"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        required
                        className="w-full h-11 pl-10 pr-12 bg-muted border border-border rounded text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary transition-colors"
                      />
                      <button
                        type="button"
