            ...
            <div className="w-full lg:w-[76%]">
              <div className="prose prose-invert max-w-none">
                ...
                <p className="text-base sm:text-lg text-muted-foreground leading-relaxed mb-6">
                  ...
                  pyrotechnics available in the market.
                </p>
                ...
                <p className="text-base sm:text-lg text-muted-foreground leading-relaxed mb-6">
                  ...
                  bringing the joy of celebration directly to your doorstep with
                ...
                <p className="text-base sm:text-lg text-muted-foreground leading-relaxed mb-6">
                  ...
                  provide detailed safety instructions with every purchase.
                </p>
                ...
                <ul className="list-disc list-inside text-base sm:text-lg text-muted-foreground leading-relaxed mb-6 space-y-2 marker:text-primary">
                  ...
                  <li>
                    Wide Variety: The largest collection of crackers online.
                  </li>
                  <li>
                    Fast Delivery: Secure and timely shipping across approved
                    regions.
                  </li>
                  <li>
                    Customer Support: Dedicated team to assist you with your
                    orders.
                  </li>
                </ul>
              </div>
