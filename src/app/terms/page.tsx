            ...
            <div className="prose prose-invert max-w-none">
              <section className="mb-10">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  strict adherence to the Explosives Rules, 2008 of India.
                </p>
              </section>
              ...
              <section className="mb-10">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground mb-4 marker:text-primary">
                  ...
                  <li>
                    You agree not to resell these items without a valid
                    explosives license.
                  </li>
                  <li>
                    You assume full responsibility for the safe storage and
              ...
              <section className="mb-10">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground mb-4 marker:text-primary">
                  ...
                  <li>
                    Discontinue any product at any time based on safety audits.
                  </li>
              ...
              <section className="mb-10">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground mb-4 marker:text-primary">
                  ...
                  <li>
                    You have authorization to use the payment method provided.
                  </li>
                  <li>
                    You acknowledge that fireworks contain hazardous materials.
                  </li>
                </ul>
              </section>
              ...
              <section className="mb-10">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  conditions, or interstate transport restrictions.
                </p>
              </section>
