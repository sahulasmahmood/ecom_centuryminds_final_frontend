...
export default function CartPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-background via-muted to-background border-b border-border">
        ...
        {items.length === 0 ? (
          ...
          <div className="max-w-md mx-auto text-center py-16">
            <div className="relative mb-8">
              <div className="w-24 h-24 bg-card border-2 border-dashed border-border rounded-full flex items-center justify-center mx-auto">
                <IconShoppingCart size={32} className="text-muted-foreground" />
              </div>
            ...
            <Link
              href="/product"
              className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-full font-semibold text-sm hover:bg-foreground hover:text-background transition-colors"
            >
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-card border border-border rounded-lg p-4 mb-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                >
                  <IconTruck size={16} className="text-primary-foreground" />
                </div>
            ...
            <div className="grid lg:grid-cols-3 gap-6">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between">
                            <div className="flex-1 min-w-0">
                              ...
                              <h4 className="text-foreground font-medium text-sm truncate group-hover:text-primary transition-colors">
                                {item.product.name}
                              </h4>
                          ...
                          <div className="flex items-center justify-between mt-3">
                            <div className="flex items-center bg-muted border border-border rounded-full">
                              <button
                                onClick={() =>
                                  updateQuantity(
                                    item.product.id,
              ...
              <div className="lg:col-span-1">
                <div className="bg-card border border-border rounded-lg p-6 sticky top-24">
                  ...
                  {/* Checkout Button */}
                  <button className="w-full bg-primary text-primary-foreground font-bold py-4 rounded-lg mt-6 hover:bg-foreground hover:text-background transition-colors uppercase tracking-wider text-sm">
                    Proceed to Checkout
                  </button>
                  ...
                  <div className="mt-6 pt-4 border-t border-border">
                    ...
                    <div className="flex gap-2">
                      {["VISA", "MC", "UPI", "GPay"].map((method) => (
                        <div
                          key={method}
                          className="bg-muted px-2 py-1 rounded text-xs font-semibold text-muted-foreground"
                        >
                          {method}
                        </div>
                      ))}
