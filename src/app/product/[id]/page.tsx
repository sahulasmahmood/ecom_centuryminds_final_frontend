    ...
    <>
      ...
      <main className="min-h-screen bg-background">
        ...
        <div className="lg:flex min-h-screen">
          ...
          <div className="w-full lg:w-[55%] lg:h-screen lg:sticky lg:top-0 bg-background flex items-center justify-center relative overflow-hidden group">
            ...
            {product.badge && (
              <div className="absolute top-24 left-8 text-white z-20">
                <span className="bg-secondary px-4 py-2 font-bold uppercase tracking-widest text-xs shadow-lg mb-2 inline-block">
                  {product.badge}
                </span>
              </div>
            )}
