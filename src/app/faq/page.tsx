    ...
    faqs: [
      {
        ...
        answer:
          "We deliver in just 10 minutes! Our express delivery ensures your groceries reach you fresh and fast.",
      },
      {
        question: "What are the delivery charges?",
        answer:
          "Delivery is FREE on orders above ₹499. For orders below ₹499, a delivery fee of ₹40 applies.",
      },
      {
        question: "Can I track my order?",
        answer:
          "Yes! Once your order is placed, you can track it in real-time through the app or website.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          "We accept UPI, Credit/Debit Cards, Net Banking, Wallets (Paytm, PhonePe), and Cash on Delivery.",
      },
      {
        question: "Is online payment safe?",
        answer:
          "Yes, all payments are secured with 256-bit SSL encryption. We never store your card details.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          "We accept returns for damaged or wrong items. Fresh produce can be returned at the time of delivery.",
      },
      {
        question: "When will I get my refund?",
        answer:
          "Refunds are processed within 2-3 business days and credited to your original payment method.",
      },
    ],
  },
];
