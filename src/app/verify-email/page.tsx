            ...
            <div className="text-center space-y-6 py-4">
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs text-gray-500">
                  Need help? <Link href="/contact" className="text-[#FFD700] hover:underline">Contact support</Link>
                </p>
              </div>
            </div>
          )}
      ...
      <div className="min-h-screen flex items-center justify-center p-4 bg-black">
        <Card className="w-full max-w-md bg-[#0a0a0a] border-white/10">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-gray-400">Please wait...</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex justify-center py-8">
              <div className="relative">
