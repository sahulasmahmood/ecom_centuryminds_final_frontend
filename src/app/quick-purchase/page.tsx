...
export default function QuickPurchasePage() {
  ...
  return (
    <>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="max-w-md mx-auto relative">
              <input
                ...
                className="w-full bg-black/50 border border-white/20 rounded-full px-6 py-3 text-white focus:outline-none focus:border-primary transition-colors"
              />
            </div>
          </div>
        </div>
          ...
          <div className="space-y-12">
            {categories.map((category) => {
              ...
              return (
                <div
                  key={category.id}
                  className="bg-card border border-white/10 rounded-lg overflow-hidden"
                >
                  {/* Category Header */}
                  <div className="bg-muted px-6 py-4 border-b border-white/10 flex items-center gap-3">
                  ...
                  <div className="hidden md:grid grid-cols-12 gap-4 px-6 py-3 bg-card text-xs font-bold text-muted-foreground uppercase tracking-widest border-b border-white/5">
                          ...
                          >
                            ...
                            <div className="hidden md:grid grid-cols-12 gap-4 px-6 py-4 items-center">
                              ...
                              <div className="col-span-2 text-center">
                                <span className="text-xs text-gray-300 bg-white/5 px-2 py-1 rounded border border-white/10">
                                  {variant.unit}
                                </span>
                              </div>
                              ...
                              <div className="col-span-2 flex items-center justify-center gap-2">
                                <button
                                  ...
                                  className="w-8 h-8 rounded bg-white/10 hover:bg-secondary hover:text-white flex items-center justify-center text-muted-foreground transition-colors"
                                >
                                  <IconMinus size={14} />
                                </button>
                                <input
                                  ...
                                  className="w-16 bg-card border border-white/20 rounded py-1.5 text-center text-white focus:outline-none focus:border-primary"
                                />
                                <button
                                  onClick={() =>
                                    incrementQty(product.id, index)
                                  }
                                  className="w-8 h-8 rounded bg-white/10 hover:bg-primary hover:text-black flex items-center justify-center text-gray-400 transition-colors"
                                >
                                  <IconPlus size={14} />
                                </button>
                              </div>
                              ...
                              <div className="flex-1">
                                ...
                                <div className="flex items-center gap-3">
                                  <button
                                    ...
                                    className="w-10 h-10 rounded bg-muted border border-white/10 flex items-center justify-center text-white"
                                  >
                                    <IconMinus size={16} />
                                  </button>
                                  <input
                                    ...
                                    className="flex-1 bg-card border border-white/20 rounded py-2 text-center text-white focus:outline-none focus:border-primary"
                                  />
                                  <button
                                    onClick={() =>
                                      incrementQty(product.id, index)
                                    }
                                    className="w-10 h-10 rounded bg-primary text-black flex items-center justify-center"
                                  >
                                    <IconPlus size={16} />
                                  </button>
                                </div>
      ...
      {/* Sticky Bottom Bar */}
      <div className="fixed bottom-0 left-0 right-0 bg-card border-t border-white/10 p-4 shadow-2xl z-40 pb-safe">
        <div className="container mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 md:gap-8 flex-1 justify-end">
            ...
            <button
              ...
              className="bg-secondary hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed text-white px-6 md:px-10 py-3 md:py-4 rounded-sm font-bold tracking-wider uppercase flex items-center gap-2 transition-all"
            >
              <IconBolt size={20} />
