            ...
            <div className="prose prose-invert max-w-none">
              <section className="mb-10">
                ...
                <p className="text-gray-300 leading-relaxed mb-4">
                  ...
                  well-being of our customers and logistics partners.
                </p>
              </section>
              ...
              <section className="mb-10">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-400 mb-4 marker:text-primary">
                  ...
                  <li>
                    Items must be returned in their original, unopened safety
                    packaging.
                  </li>
                  <li>
                    Evidence (Photos/Videos) of unboxing must be provided within
                    24 hours.
                  </li>
                </ul>
              </section>
              ...
              <section className="mb-10">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-400 mb-4 marker:text-primary">
                  ...
                  <li>
                    Items damaged due to mishandling or improper storage (e.g.,
                    water exposure) by the customer.
                  </li>
              ...
              <section className="mb-10">
                ...
                <p className="text-gray-300 leading-relaxed mb-4">
                  ...
                  coupon code for duds if they exceed 10% of the box quantity.
                </p>
              </section>
