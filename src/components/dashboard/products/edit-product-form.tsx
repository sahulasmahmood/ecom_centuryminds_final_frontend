  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.purchasePrice)
        updateData.purchasePrice = parseFloat(formData.purchasePrice);
      if (formData.mrp) updateData.mrp = parseFloat(formData.mrp);
      if (formData.gstPercentage)
        updateData.gstPercentage = parseFloat(formData.gstPercentage);
      ...
      if (formData.piecesPerPack)
        updateData.piecesPerPack = formData.piecesPerPack;
      if (formData.safetyDistance)
        updateData.safetyDistance = formData.safetyDistance;
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 pb-20">
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <Card className="bg-gradient-to-br from-gray-50 to-gray-100/50 border-gray-200 shadow-sm mb-6">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center h-10 px-3 bg-white border border-gray-200 rounded-md">
                  <span className="text-sm text-gray-700">
                    {productMetadata.createdAt
                      ? new Date(productMetadata.createdAt).toLocaleDateString(
                          "en-IN",
                          {
                            year: "numeric",
                            month: "short",
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center h-10 px-3 bg-white border border-gray-200 rounded-md">
                  <span className="text-sm text-gray-700">
                    {productMetadata.updatedAt
                      ? new Date(productMetadata.updatedAt).toLocaleDateString(
                          "en-IN",
                          {
                            year: "numeric",
                            month: "short",
