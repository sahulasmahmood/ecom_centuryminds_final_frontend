            ...
            <div className="flex gap-4 pt-2">
              {[
                ...
                <a
                  key={i}
                  href="#"
                  className="w-10 h-10 bg-background rounded-sm flex items-center justify-center text-muted-foreground hover:text-black hover:bg-primary transition-all duration-300 group"
                >
                  <Icon
                    size={18}
